...
TID003_1DeviceClass::TID003_1DeviceClass(int id, int ComPort,TLogClass* _Log): CValidator(id, ComPort,_Log, "WBA003_1Validator")
{
  DataLengthIndex = 1;
  BeginByte = 0xFC;
  delete Port;
...
TID003_1DeviceClass::~TID003_1DeviceClass()
{
}

void TID003_1DeviceClass::Start()
{
  ...
  DeviceThread = new TID003_1DeviceThread();
...
bool TID003_1DeviceClass::IsItYou()
{
