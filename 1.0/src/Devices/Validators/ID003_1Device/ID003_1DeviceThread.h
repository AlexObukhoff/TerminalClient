...
#ifndef ID003_1DeviceThreadH
#define ID003_1DeviceThreadH
//---------------------------------------------------------------------------
...
class TID003_1DeviceThread : public TDeviceThread
{
private:
    int OfflineCount;
    BYTE inter_crc_h;
...
protected:
    ...
    virtual void __fastcall TID003_1DeviceThread::ProcessLoopCommand();
    virtual void PollingLoop();
    virtual void ProcessOutCommand();
public:
    __fastcall TID003_1DeviceThread();
    virtual __fastcall ~TID003_1DeviceThread();
    bool IsItYou();
};
#endif
