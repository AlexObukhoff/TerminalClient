...
__fastcall TID003_1DeviceThread::TID003_1DeviceThread() : TDeviceThread(true)
{
}

__fastcall TID003_1DeviceThread::~TID003_1DeviceThread()
{
}

void TID003_1DeviceThread::calc_crc(BYTE byte)
{
   unsigned char i,c;
...
unsigned short TID003_1DeviceThread::Calc_CRC16CCNET(BYTE* DataBuf, unsigned short  BufLen)
{
   unsigned short i;
...
void TID003_1DeviceThread::SendPacket(BYTE command,int len_packet, BYTE* data)
{
  if (!Port->PortInit)
  {
...
void TID003_1DeviceThread::SendACK()
{
  if (!Port->PortInit)
  {
    DeviceState->StateCode = 0xff;
...
void TID003_1DeviceThread::GetStay()//POLL command
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Reset()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Stack1()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Stack2()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Return()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Hold()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Wait()
{
  try
  {
    if (!Port->PortInit)
...
int  TID003_1DeviceThread::Stack()
{
    Stack1();
    if (DeviceState->StateCode == 0xff)
      return 0;
...
std::string TID003_1DeviceThread::GetStatusDescription(BYTE StatusCode)
{
    switch(StatusCode)
    {
        case 0x11:
...
std::string TID003_1DeviceThread::GetRejectionDescription(BYTE StatusCode)
{
    switch(StatusCode)
    {
        case 0x71:
...
std::string TID003_1DeviceThread::GetFailureDescription(BYTE StatusCode)
{
    switch(StatusCode)
    {
        case 0xA2:
...
void TID003_1DeviceThread::EnableAll()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::Disable()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::WriteEnableDenomination()
{
  try
  {
    if (!Port->PortInit)
...
void TID003_1DeviceThread::PollingLoop()
{
    AnsiString mess;
    int error=0;
    AnsiString errormsg;
      ...
      switch (State)
      {
          ...
          case ESCROW:
          {
             ...
             if (Currency.LowerCase() == "kzt")
             {
              ...
              Log->Write((boost::format("Accepting nominal = %1%; code = %2%") % bill_nominal % DeviceState->SubStateCode).str().c_str());
...
void TID003_1DeviceThread::ParseAnswer(int mode)
{
  try
  {
    ClearBuffer(data);
...
std::string TID003_1DeviceThread::GetStateDescription(int code)
{
  return GetStatusDescription((BYTE)code);
}

bool TID003_1DeviceThread::IsItYou()
{
    GetStay();
    if (DeviceState->StateCode == 0xFF)
        return false;
...
void __fastcall TID003_1DeviceThread::ProcessLoopCommand()
{
...
void TID003_1DeviceThread::ProcessOutCommand()
{
    try
    {
