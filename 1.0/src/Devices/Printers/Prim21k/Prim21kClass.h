...
#ifndef Prim21kClassH
#define Prim21kClassH
//---------------------------------------------------------------------------
#endif
...
class CPrim21kClass : public CPrinter
{
private:
//====================================================================================
    ...
    std::string GetErrorExplanationString(BYTE Code);
...
public:
  CPrim21kClass(int ComPort, int BaudRate = 0, TLogClass* _Log = NULL);
  virtual ~CPrim21kClass();
