...
extern void bscan(char *binary, int data, int h);

#define nitems(a) (sizeof(a) / sizeof(a[0]))
#define charMalloc(a) (char *)malloc(a)
#define uint8Malloc(a) (uint8_t *)malloc(a)
#define intMalloc(a) (int *)malloc((a) * sizeof(int))
#define unsignedMalloc(a) (unsigned int *)malloc((a) * sizeof(unsigned int))
