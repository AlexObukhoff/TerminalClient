...
Controls.KeyboardBase {
	...
	Column {
		...
		Row {
			...
			KeyboardButton { width: 258; iconId: 33; disabled: false; onClicked: altMode = !altMode;  background: BorderImage { border { left: 40; top: 40; right: 40; bottom: 40 } source: altMode ? "image://ui/button.function.pressed" : "image://ui/button.function.normal"}}
			KeyboardButton { text: _("-"); altText: _("("); backgroundSource: "button.function" }
