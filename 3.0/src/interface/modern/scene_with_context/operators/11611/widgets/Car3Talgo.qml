...
Image {
	...
	source: "images/type3.talgo.png"

	Row {
		anchors { left: parent.left; leftMargin: 158; top: parent.top; topMargin: 199 }
		width: parent.width

		Repeater {
			model: ListModel { id: row1Model }
			delegate: Place { width: index % 2 ? 74 : 119 }
		}
	}

	Row {
		anchors { left: parent.left; leftMargin: 158; top: parent.top; topMargin: 299 }
		width: parent.width
