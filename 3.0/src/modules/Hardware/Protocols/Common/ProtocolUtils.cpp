...
//--------------------------------------------------------------------------------
bool getBit(const QByteArray & aBuffer, int aShift, bool invert)
{
...
//--------------------------------------------------------------------------------
QString hexToBCD(const QByteArray & aBuffer, char filler)
{
	QString result;
...
//--------------------------------------------------------------------------------
QByteArray getHexReverted(double aValue, int aSize, int aPrecision)
{
