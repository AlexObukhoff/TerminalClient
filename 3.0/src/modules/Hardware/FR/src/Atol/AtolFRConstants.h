...
namespace CAtolFR
{
	...
	/// Формат печати X- и Z-отчетов - печатать необнуляемую сумму с момента последней перерегистрации на расширенном отчете, автовыплату (сумма в кассе) не делать
	const char ReportMode = '\x0B';
