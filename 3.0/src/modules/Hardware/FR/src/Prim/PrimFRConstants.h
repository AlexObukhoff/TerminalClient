...
namespace CPrimFR
{
	...
	h - высота
	w - ширина
	k - тип 0-6, 65-75: 49 == 73 - CODE128
	T - строка штрихкода: 7B - переключатель страниц CODE128, 42 - номер страницы (CODE-B) 
	j - число точек поле штрихкода
	J - выравнивание (0-1-2 лево-центр-право): 01 - по центру
	R - смещение штрихкода слева если нет выравнивания.
	*/
	const char BarcodeData[] = "h30H00w02f31J01R00k49T7B42";
	...
	namespace Errors
	{
		...
		public:
			Data()
			{
				...
				add('\x08', "Время изменилось больше чем на 24 часа");
